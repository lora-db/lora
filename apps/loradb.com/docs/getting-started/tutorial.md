...
<QueryCodeBlock code={String.raw`MATCH (ada:Person   {name: 'Ada'}),
...
<QueryCodeBlock code={String.raw`MATCH (follower:Person)-[:FOLLOWS]->(leader:Person)
...
<QueryCodeBlock code={String.raw`MATCH (n:Person)-[:FOLLOWS]->(mid:Person)-[:FOLLOWS]->(ada:Person {name: 'Ada'})
...
<QueryCodeBlock code={String.raw`MATCH p = (linus:Person {name: 'Linus'})-[:FOLLOWS*1..3]->(ada:Person {name: 'Ada'})
...
<QueryCodeBlock code={String.raw`MERGE (p:Person {name: 'Ada'})
...
<QueryCodeBlock code={String.raw`MATCH (alan:Person {name: 'Alan'})
DETACH DELETE alan`} />
