...
//   - crates/bindings/lora-wasm/pkg-*/package.json   generated by wasm-pack, gitignored
//   - Cargo.lock, package-lock.json                  refreshed separately via `cargo check --workspace`
//                                                    and `npm install --package-lock-only` in each dir
//   - crates/bindings/lora-ruby/Gemfile.lock         refreshed by `bundle install` when the
...
if (checkOnly) {
  ...
  console.log('  (cd crates/bindings/lora-node    && npm install --package-lock-only --ignore-scripts)');
  console.log('  (cd crates/bindings/lora-wasm    && npm install --package-lock-only --ignore-scripts)');
  console.log('  (cd apps/loradb.com     && npm install --package-lock-only --ignore-scripts)');
  console.log('  (cd crates/bindings/lora-ruby    && bundle install)');
